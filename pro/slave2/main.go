...
func main() {
	...
	fmt.Println("Slave server running on port 8003...")
...
func startElection() {
	...
	// Only promote to master if slave1 (8002) is down
	if os.Getenv("PORT") == "8003" {
		// Check if slave1 is down
		_, err := http.Get("http://localhost:8002/ping")
		if err != nil {
			promoteToMaster()
		}
	}
